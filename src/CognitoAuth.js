...
+     this.signInUserSession.setTokenScopes(tokenScopes);
    ...
    clearCachedTokensScopes() {
      const keyPrefix = `CognitoIdentityServiceProvider.${this.getClientId()}`;
      const idTokenKey = `${keyPrefix}.${this.getCurrentUser}.idToken`;
      const accessTokenKey = `${keyPrefix}.${this.getCurrentUser}.accessToken`;
      const refreshTokenKey = `${keyPrefix}.${this.getCurrentUser}.refreshToken`;
      const lastUserKey = `${keyPrefix}.LastAuthUser`;
      const scopeKey = `${keyPrefix}.${this.getCurrentUser}.tokenScopesString`;
